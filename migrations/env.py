...
# Set target metadata from SQLModel (includes all table models)
...
def render_item(type_, obj, autogen_context):
    """Render SQLModel AutoString as String for migrations."""
...
def do_run_migrations(connection: Connection) -> None:
    """Run migrations using the sync connection.

    This is called via run_sync() from the async engine.
    """
    context.configure(
...
async def run_async_migrations() -> None:
    ...
    and use run_sync() to run migrations.
    """
