...
1. **Read the source material first** - Locate and read the literature note or permanent note before starting discussion
2. **Ask questions to test understanding** - Use Socratic method
3. **Challenge interpretations** - Explore alternative perspectives
4. **Connect to existing knowledge** - Link to related concepts
5. **Extract concepts** - End by asking which atomic concepts to extract into permanent notes
