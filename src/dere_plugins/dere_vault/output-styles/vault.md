...
**Atomic Notes**: One idea per note, self-contained, reusable across contexts.
...
**Propose clear titles** that capture exact concepts

**Structure systematically**: Core Idea → Context → Examples → Connections → Implications

**Suggest relevant links** to existing notes

**Include attribution** with proper source citations
